...
export default function Step2FloorPlan({ bookingDetails, onBack, onSuccess }) {
    ...
    async function fetchData() {
      try {
        ...
        const query = new URLSearchParams({
          ...
          time: form.time, // Use selected time
  ...
  }, [bookingDetails.date, form.time]); // Add form.time dependency
  ...
  if (loading) {
    return <div className="text-dickens-green text-2xl py-20 text-center">Laster inn bordkart...</div>;
  }
  ...
  if (submitted) {
    return (
      <div className="flex-grow flex flex-col items-center justify-center w-full h-full">
        ...
        <p className="text-lg text-gray-700 mb-8">Vi har mottatt din booking for {bookingDetails.date} kl {form.time}.</p>
          ...
          <form onSubmit={handleBook} className="flex flex-col gap-2">
            <div className="flex flex-col gap-1">
              ...
              <input 
                ...
                className="border border-gray-300 rounded px-2 py-1.5 text-sm focus:outline-none focus:border-dickens-gold focus:ring-1 focus:ring-dickens-gold"
              />
            </div>
            ...
            <div className="flex flex-col gap-1">
              ...
              <div className="flex flex-row w-full gap-2">
                <select 
                  ...
                  className="border border-gray-300 rounded px-1 py-1.5 text-sm focus:outline-none focus:border-dickens-gold focus:ring-1 focus:ring-dickens-gold bg-white w-[70px] shrink-0"
                >
                  {COUNTRIES.map(c => (
                ...
                <input 
                  ...
                  className={`flex-1 min-w-0 border ${phoneError ? 'border-red-500 focus:border-red-500 focus:ring-red-500' : 'border-gray-300 focus:border-dickens-gold focus:ring-dickens-gold'} rounded px-2 py-1.5 text-sm focus:outline-none focus:ring-1`}
                />
              </div>
            ...
            <div className="flex gap-2">
              <div className="flex flex-col gap-1 flex-1">
                <label className="text-xs font-semibold text-gray-600 uppercase tracking-wide">Tidspunkt</label>
                <input 
                  type="time" required
              ...
              <div className="flex flex-col gap-1 w-20">
                <label className="text-xs font-semibold text-gray-600 uppercase tracking-wide">Gjester</label>
                <input 
            ...
            <button 
              ...
              className={`w-full py-3 mt-2 rounded-lg font-bold text-lg transition-colors shadow-md ${
                selectedTable && !phoneError && form.phone
